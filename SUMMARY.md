...
- [The AI solution architect operating model](docs/00-orientation/01-operating-model.md)
- [Bootcamp format, labs & portfolio](docs/00-orientation/02-bootcamp-format.md)
- [The Northstar recurring case](docs/00-orientation/03-northstar-case.md)

## Part 1 — AI solution architecture foundations

- [The AI solution architecture method](docs/01-ai-sa-foundations/00-probabilistic-architecture.md)
- [AI discovery & problem framing](docs/01-ai-sa-foundations/01-discovery-framing.md)
- [Requirements, NFRs & quality attributes](docs/01-ai-sa-foundations/02-requirements-nfrs.md)
- [C4, sequence diagrams & AI ADRs](docs/01-ai-sa-foundations/03-diagrams-adrs.md)
- [Build, buy, adapt, or abstain](docs/01-ai-sa-foundations/04-build-buy-abstain.md)

## Part 2 — The AI landscape & model strategy

- [Rules, search, ML, GenAI & agents](docs/02-ai-landscape/00-system-patterns.md)
- [Foundation model capabilities & limits](docs/02-ai-landscape/01-foundation-models.md)
- [Model portfolio strategy & evidence-based selection](docs/02-ai-landscape/02-model-selection.md)
- [Prompt contracts, structured outputs & constrained generation](docs/02-ai-landscape/03-prompting-structured-output.md)
...
- [AI data readiness, lineage & provenance](docs/03-data-context/00-data-readiness.md)
- [Embeddings, chunking & retrieval](docs/03-data-context/01-retrieval-foundations.md)
- [Production RAG: evidence, freshness & operations](docs/03-data-context/02-rag-patterns.md)
- [Knowledge graphs, SQL & hybrid retrieval](docs/03-data-context/03-hybrid-retrieval.md)
- [Agentic memory systems](docs/03-data-context/04-context-memory.md)
- [Data governance, lineage & provenance](docs/03-data-context/05-governance-provenance.md)
...
- [The inference request path](docs/04-llm-systems/00-request-path.md)
- [Model gateways, routing & fallbacks](docs/04-llm-systems/01-gateways-routing.md)
- [Production LLM reliability, latency & capacity](docs/04-llm-systems/02-reliability-latency.md)
...
- [From workflows to agents](docs/05-agents/00-workflows-vs-agents.md)
- [Agent identity, tools & delegated authorization](docs/05-agents/01-tools-authorization.md)
- [Durable agent orchestration, state & recovery](docs/05-agents/02-orchestration-state.md)
- [Memory & multi-agent patterns](docs/05-agents/03-memory-multi-agent.md)
- [Approvals, compensating actions & recovery](docs/05-agents/04-approvals-recovery.md)
...
- [Agentic AI threat modeling & security testing](docs/07-security-governance/00-threat-modeling.md)
- [Prompt injection & tool abuse](docs/07-security-governance/01-prompt-injection.md)
- [Identity, secrets & least privilege](docs/07-security-governance/02-identity-secrets.md)
- [Privacy, residency & confidential data](docs/07-security-governance/03-privacy-residency.md)
...
- [Portability, lock-in & exit plans](docs/08-platform-operations/05-portability.md)
...
- [AI unit economics, value & production delivery](docs/09-economics-delivery/00-unit-economics.md)
- [FinOps for tokens, retrieval & tools](docs/09-economics-delivery/01-finops.md)
- [Value hypotheses, KPIs & benefits realization](docs/09-economics-delivery/02-value-kpis.md)
...
- [Reference architecture method & review pack](docs/10-reference-architectures/00-method.md)
- [Enterprise knowledge assistant](docs/10-reference-architectures/01-knowledge-assistant.md)
- [Document intelligence pipeline](docs/10-reference-architectures/02-document-intelligence.md)
- [Customer-service copilot](docs/10-reference-architectures/03-customer-copilot.md)
