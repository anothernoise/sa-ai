# The AI solution architect operating model
...
Define where the AI SA owns decisions, facilitates decisions, and hands off accountability.
...
A RACI spanning product, engineering, data, security, legal, risk, and operations.
