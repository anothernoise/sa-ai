...
Translate a fictional enterprise's ambitions and constraints into a stable case used across the book.
...
A one-page case brief, stakeholder map, and initial assumption log.
