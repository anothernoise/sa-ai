...
Meet conversational latency while handling interruption, identity, consent, escalation, and partial failure.
...
A real-time media and action sequence with latency budget.
