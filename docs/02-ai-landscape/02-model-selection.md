# Model selection as an evidence process
...
Select models using representative tasks, policy constraints, latency, availability, and total cost.
...
A model bake-off plan and scorecard.
