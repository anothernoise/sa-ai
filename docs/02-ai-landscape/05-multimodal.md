# Multimodal & speech architectures
...
Design image, document, audio, and real-time speech paths with modality-specific quality and latency budgets.
...
A multimodal sequence diagram and modality test plan.
