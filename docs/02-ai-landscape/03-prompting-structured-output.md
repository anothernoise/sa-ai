# Prompting, structured outputs & constrained generation
...
Choose between free text, schemas, constrained decoding, and validation for each interface.
...
A versioned prompt contract and output schema.
