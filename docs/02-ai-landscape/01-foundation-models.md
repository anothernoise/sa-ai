...
Reason about model families, context, reasoning, modalities, and failure modes without treating a model as the whole system.
...
A capability-and-constraint card for a candidate model.
