# Fine-tuning, distillation & small models
...
Decide when prompting and retrieval are insufficient and adaptation is justified.
...
An adaptation ADR with data, evaluation, rollback, and ownership requirements.
