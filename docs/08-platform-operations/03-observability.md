...
Observe request traces, model behavior, retrieval, tools, safety, user outcomes, and cost without leaking sensitive content.
...
A telemetry schema and operational dashboard design.
