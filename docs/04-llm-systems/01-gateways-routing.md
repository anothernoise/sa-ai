# Model gateways, routing & fallbacks
...
Centralize policy and route requests without creating an opaque, fragile bottleneck.
...
A gateway responsibility map and routing ADR.
