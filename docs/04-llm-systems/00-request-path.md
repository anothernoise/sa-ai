...
Decompose a user request into identity, policy, context, inference, tools, validation, and response stages.
...
An end-to-end request sequence with trust boundaries.
