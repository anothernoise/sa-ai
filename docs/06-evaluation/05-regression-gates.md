# Regression gates & release decisions
...
Block releases when quality, safety, latency, or cost regress beyond agreed tolerances.
...
A CI evaluation gate and rollback rule.
