# Define quality before choosing a model
...
Translate user value and harm into a layered evaluation strategy before implementation.
...
An evaluation charter tied to release decisions.
