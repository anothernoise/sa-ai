# Architecture thinking for probabilistic systems
...
Design for variable, non-deterministic behavior without abandoning normal software-engineering discipline.
...
A quality-attribute scenario for an AI feature.
