...
Select the diagram and decision record that exposes data flow, trust, and runtime behavior.
...
A C4 context/container pair, one sequence diagram, and three ADRs.
