# Privacy, residency & confidential data
...
Map every data hop—including logs, support, and model processing—to purpose, jurisdiction, and retention.
...
A cross-border data-flow and privacy impact assessment.
