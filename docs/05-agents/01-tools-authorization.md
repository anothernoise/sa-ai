...
Expose narrow, typed tools and authorize every call independently of the model's intent.
...
A tool catalog with scopes, preconditions, and audit fields.
