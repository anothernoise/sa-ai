...
Add memory or multiple agents only when separation of context, authority, or expertise justifies the complexity.
...
A pattern comparison with explicit rejection criteria.
